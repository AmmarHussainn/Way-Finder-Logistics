...
const Navbar = () => {
  ...
  return (
    <div className='bg-white/80 backdrop-blur-md h-[100px] px-6 py-4 pt-6 fixed w-full top-0 z-50 shadow-sm border-b border-gray-200'>
      <div className='flex lg:px-8 justify-between items-center max-w-8xl mx-auto'>
        {/* Logo replaced with text */}
        <div>
          <a href='/' className='text-2xl font-bold text-gray-800'>
            Way Finder Logistics
          </a>
        </div>
