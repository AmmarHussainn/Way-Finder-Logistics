  ...
  return (
    <section id='aboutsection' className='bg-[##ffffff] py-20 px-6 lg:px-32'>
      <div className='max-w-7xl mx-auto text-center'>
        <h2 className='text-5xl font-extrabold text-[#252525] mb-8'>About Way Finder Logistics</h2>
        <p className='text-xl text-[#252525] leading-relaxed mb-8'>
          <strong>Way Finder Logistics</strong> is a premier truck dispatching service designed to empower
        ...
        <p className='text-xl text-[#252525] leading-relaxed mb-8'>
          ...
          and providing <strong>24/7 support</strong>. With Way Finder Logistics, you can focus on the road while we handle
